...
PDF_PATH = "pnpkSaluranCerna_retinoblastoma.pdf"
window_size = 3
similarity_top_k = 80
rerank_top_n = 4
...
if not GROQ_API_KEY or not PINECONE_API_KEY:
    st.error("❌ API Key belum lengkap di file .env.")
    st.stop()
...
def load_documents_from_pdf():
    ...
    return [Document(text=markdown_text)]
...
# MAIN UI
# =========================
st.title("📄 QA Dokumen PPNPK Retinoblastoma (pymupdf4llm + Pinecone v2)")
